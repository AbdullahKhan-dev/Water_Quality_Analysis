...
Sensor(s): 
Keywords: surface water, nutrients, alkalinity, cations, grab samples, nitrogen (N), acid neutralizing capacity (ANC), carbon (C), chemistry, analytes, phosphorous (P), total carbon (TC), chemical properties, water quality, anions
Domain: D12
DATA PACKAGE CONTENTS
---------------------
This folder contains the following documentation files:
This data product contains up to 7 data tables:
- Term descriptions, data types, and units: NEON.D12.BLDE.DP1.20093.001.variables.20220516T155515Z.csv
